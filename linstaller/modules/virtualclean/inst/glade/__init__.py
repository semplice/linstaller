...
class Remove(glade.Progress):
	def progress(self):
		...
		self.parent.progress_set_text(_("Removing virtual machine specific packages..."))

		try:
			# Type
			typ = self.parent.moduleclass.install.type
			
			# Remove
			self.parent.moduleclass.install.remove(typ)
...
class Frontend(glade.Frontend):
	def ready(self):
		...
		self.set_header("hold", _("Removing virtual machine specific packages..."), _("This may take a while."))
