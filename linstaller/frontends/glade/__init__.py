...
class Frontend(linstaller.core.frontend.Frontend):
	...
	def steps_init(self, okmessage={"title":_("You can continue!"), "message":_("Press forward to continue.")}, holdmessage={"title":_("There are some incomplete items (hover to see)."), "message":_("You need to complete the following items:")}, errormessage={"title":_("There are some errors (hover to see)."), "message":_("You need to fix these errors before continuing:")}):
		""" Initiate steps. """
	...
	def on_objects_ready_internal(self):
		""" Called when the module objects are ready. (for internal use)"""
